...
import TableAnalyticsSA from "../../components/Analytics/TableAnalyticsSA";
		...
		<MainPage>
			...
			>
				<ModalBox sx={{ width: { xs: "390px", md: "600px", lg: "780px" } }}>
					<DownLoadReportSA setModal={setModal} filters={filters} />
				</ModalBox>
			</Modal>
			<Header count={count} />
